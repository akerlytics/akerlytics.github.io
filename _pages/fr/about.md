...
<!-- Dans l’article 1 du RSI, il est proposé de retirer le terme « non-contraignant » du texte décrivant la nature des avis produits par l’OMS. [Élaborer un peu sur les conséquences de cela].

De plus, les amendements proposent une refonte substantiellement de l’article 13 du RSI. Celui-ci [description du contenu original]. Maintenant, il ne permet plus de XXXX.  -->
...
Une lettre a été adressée à nos représentants pour insister sur l'importance de mener des analyses détaillées avec un soutien démocratique, dans le cadre des modifications légales proposées par l'OMS et ses États membres.
Vous aussi vous pouvez envoyer une lettre similaire à votre député!
...
Afin de protéger la souveraineté du Canada en cas de risque sanitaire mondial, trois pétitions ont été lancées, une à la Chambre des communes et une autre au gouvernement du Canada. Les signataires demandent que toute signature d’un traité international sur la pandémie par l’OMS soit approuvée par référendum public.
Pour suivre l’évolution de ces pétitions : [liens]
Pour démarrer la vôtre : [liens] -->
...
Site web de la député et avocate Leslyn Lewis
Article répondant aux craintes de Leslyn Lewis
Résumé des débats au Rayaume-Uni
Plus d’information sur les pétions en cours -->
